...
== Volume binding using docker-compose

In order to use volume binding in docker-compose, Windows absolute paths must be defined as shown in the following example:

```
volumes:
  - C:\Users\Joey\Desktop\backend:/var/www/html -> - /c/Users/Joey/Desktop/backend:/var/www/html
```
