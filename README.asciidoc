...
Using Linux containers with Rancher Desktop is very simple, just make sure that you don't change default containerd runtime, and go ahead using the Docker commands you are used to:
