...
IMPORTANT: You may be asked to reboot your computer. This happens when you do not have the required Windows features enabled. If so, relaunch installation process after restart.
