...
{
    $search = (Get-Content $script:bashProfilePath | Select-String -Pattern '# generated by Rancher-Desktop for Alias support in Git Bash').Matches.Success
    if( -Not $search){
        Add-Content $script:bashProfilePath "# generated by Rancher-Desktop for Alias support in Git Bash"
...
function ActivateWslVpnkit
{
    ...
    $search = (Get-Content $PROFILE | Select-String -Pattern '# generated by Rancher-Desktop for VPN support in Powershell').Matches.Success
    if( -Not $search){
        Add-Content $PROFILE "# generated by Rancher-Desktop for VPN support in Powershell"
        Add-Content $PROFILE "# Start the VPN support"
        Add-Content $PROFILE "wsl -d wsl-vpnkit service wsl-vpnkit start 2> `$null"
    }
    $search = (Get-Content $script:bashProfilePath | Select-String -Pattern '# generated by Rancher-Desktop for VPN support in Git Bash').Matches.Success
    if( -Not $search){
        Add-Content $script:bashProfilePath "# generated by Rancher-Desktop for VPN support in Git Bash"
        Add-Content $script:bashProfilePath "# Start the VPN support"
        Add-Content $script:bashProfilePath "wsl -d wsl-vpnkit service wsl-vpnkit start 2> `$null"
    }
